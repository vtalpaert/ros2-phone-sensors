...
setup(
    ...
    data_files=[
        ...
        (
            os.path.join("lib", "static"),
            glob("templates/static/*.js") + glob("templates/static/*.css"),
        ),
    ],
    install_requires=[
        "setuptools",
    ...
    description="Serve a webpage to open from a mobile device. "
    + "The phone's browser will send video, imu and gps data back to the node",
    license="Apache-2.0",
